// Dice Parent Super Class
import java.util.Random;

public class Dice
{
	private String diceEncapsulation;
	   int rNum = 0;
       static int Throw = 0;
    ...
    {
              throwSum = Throw;
              System.out.println( "ALL Dice thrown = " + throwSum );
    ...
    public String toString(int rNum) 
    {
    	...
    	System.out.println("\nDice Class ToString Method:\nThe number of dices = " + countNumberOfDices);
    	lastValueThrown = Integer.toString(Throw);
        System.out.println("The last value thrown = " + lastValueThrown);
        return lastValueThrown; 
	} // end toString method
    
    public String getDiceEncapsulation(String name) 
    {
    	this.diceEncapsulation = name;
        System.out.println("\nThe private Dice SuperClass encapsulation = " + diceEncapsulation);
        return diceEncapsulation; 
	} // end toString method
